...
export const QueuesView: React.FunctionComponent<Navigate> = navigate => {
  ...
  return (
    <div>
        ...
        <MessagesTable ref={messagesTableRef} address={currentQueue.address} queue={currentQueue.name} routingType={currentQueue.routingType} selectMessage={selectMessage} onTotalCountChange={handleTotalCountChange} back={back}/></div>
        {activeTabKey === 2 &&
        <>
